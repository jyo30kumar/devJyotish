          ...
          <div className="popup_details">
            <div className="top_image">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    'url("img/portfolio/portfolioDetail/cantiLogo.png")',
            ...
            <div className="portfolio_main_title">
              <a
                href="https://www.cantileverlabs.com/"
                target="_blank"
            ...
            <div className="main_details">
              <div className="textbox">
                <p>
                  I have worked as a intern for a 6 month on a Cantileverlabs.My
                  responsibility is to maintain and create apis and then
                  integrating it on Frontend
                </p>
